package cleantool.su.piccompress;
...
public class ImageWorker {
    ...
    public void loadImage(long origId, ImageView imageView) {
        ...
        if (bitmapDrawable != null) {
            ...
            final AsyncDrawable asyncDrawable = new AsyncDrawable(mResources, mLoadBitmap, loadBitmapTask);
    ...
    private class LoadBitmapTask extends AsyncTask<Long, Void, BitmapDrawable> {
        ...
        protected BitmapDrawable doInBackground(Long... params) {
            ...
            if (bitmapCache != null && !isCancelled() && getAttachedImageView() != null && !mExitTasksEarly) {
                bitmap = MediaStore.Images.Thumbnails.getThumbnail(mContentResolver, origId, MediaStore.Images.Thumbnails.MINI_KIND, mOptions);
            }
