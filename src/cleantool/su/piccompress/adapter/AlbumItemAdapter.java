...
public class AlbumItemAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Holder holder;
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.pic_album_item_images_item_view, parent, false);
            holder = new Holder();
        ...
        holder.tv_size.setText(CommonUtil.getSizeStr(mContext, list.get(position).getImagePath()));
